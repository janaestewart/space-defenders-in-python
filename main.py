...
player_ship: Sprite = None
enemy_ship: Sprite = None
player_projectile: Sprite = None
...
#move our player
controller.move_sprite(player_ship, 100, 0)

#keep player in the screen
player_ship.set_stay_in_screen(True)
...
def on_update_interval():
    invaders = sprites.create_projectile_from_side(list3[randint(0, 2)], 0, 50)
    invaders.set_position(randint(0, scene.screen_width()), 0)
    invaders.set_kind(SpriteKind.enemy)
